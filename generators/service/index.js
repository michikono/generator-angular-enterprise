  ...
  writing: {
    files: function () {
      ...
      this.installTemplate(
        ...
        this.destinationPath(path + changeCase.paramCase(this.choices.name) + '.service.js')
      );
      if (this.choices.tests) {
        this.installTemplate(
          this.templatePath('_.service.spec.js'),
          this.destinationPath(path + changeCase.paramCase(this.choices.name) + '.service.spec.js')
        );
      }
    }
  }
